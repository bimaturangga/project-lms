...
export default function ProfilePage() {
  ...
  const certificates = useQuery(
    api.certificates.getCertificatesByUser,
    user?._id ? { userId: user._id } : "skip",
  );

  // Mutation untuk update user avatar
  const updateUserAvatar = useMutation(api.users.updateUser);
  ...
  const totalHours = 0; // Placeholder - bisa dihitung dari course duration
            ...
            <div className={styles.profileCard}>
              ...
              <div className={styles.profileStats}>
                <div className={styles.statItem}>
                  ...
                  <div className={styles.statLabel}>Kursus</div>
                </div>
                <div className={styles.statItem}>
                ...
                <div className={styles.statItem}>
                  ...
                  <div className={styles.statLabel}>Jam</div>
                </div>
              </div>
            </div>
        ...
        {showSuccessModal && (
          ...
          >
            ...
            >
              ...
              <p className={styles.modalText}>Profil berhasil diperbarui.</p>
              <button
